"""
models/encoder_a3.py — A3 VQ-VAE CameraEncoder
===============================================
Targets z_e(64) continuous → quantized to codebook entry.
Same backbone as encoder.py but with latent_dim=64.
"""
...
class CameraEncoderVQ(nn.Module):
